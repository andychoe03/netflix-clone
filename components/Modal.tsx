...
import { HandThumbUpIcon, PlusIcon, SpeakerWaveIcon, SpeakerXMarkIcon } from "@heroicons/react/24/solid"
        ...
        <div className="flex space-x-16 rounded-b-md bg-[#181818] px-10 py-8">
            <div className="space-y-6 text-lg">
                <div className="flex items-center space-x-2 text-sm">
                    ...
                    <div className="flex h-4 items-center justify-center rounded border border-white/40 px-1.5 text-xs"> </div>
                </div>
